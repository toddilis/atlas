// Generated by scripts/gen-types.sh from supabase/migrations — do not edit by hand.
// Regenerate after adding a migration: npm run gen:types
export type Json =
  | string
  | number
  | boolean
  ...
  public: {
    Tables: {
      ...
      event_projections: {
        Row: {
          ...
          org_id: string
          seq: number
          state: Database["public"]["Enums"]["projection_state"]
          updated_at: string
        }
        Insert: {
          attempts?: number
        ...
        Relationships: [
          {
            foreignKeyName: "event_projections_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "event_log"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "event_projections_org_id_fkey"
            columns: ["org_id"]
            referencedRelation: "orgs"
            referencedColumns: ["id"]
          },
      ...
      statement_lines: {
        Row: {
          ...
          description: string
          id: string
          line_type: Database["public"]["Enums"]["statement_line_type"]
          occurred_at: string
          org_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "statement_lines_org_id_fkey"
            columns: ["org_id"]
            referencedRelation: "orgs"
            referencedColumns: ["id"]
          },
      ...
      statements: {
        Row: {
          ...
          sent_at: string | null
          state: Database["public"]["Enums"]["statement_state"]
        }
        Insert: {
          account_id: string
          aging_30_cents?: number
    ...
    Functions: {
      ...
      post_payment_received: {
        ...
        Returns: {
          invoice_state: Database["public"]["Enums"]["invoice_state"]
          ledger_transaction_id: string
          payment_id: string
        }[]
      }
      record_stripe_payment: {
        ...
        Returns: {
          ...
          rsp_invoice_state: Database["public"]["Enums"]["invoice_state"]
    ...
    Enums: {
      ...
      projection_state: "pending" | "projected" | "failed" | "dead"
      risk_tier: "auto" | "notify" | "approve_required"
      statement_line_type: "opening" | "invoice" | "payment" | "closing"
      statement_state: "draft" | "sent" | "voided"
